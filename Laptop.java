...
public class Laptop {
    ...
    public Set<Laptop> newFilter(Set<Laptop> laptop) {
        ...
        System.out.println("Укажите порядковый номер необходимого критерия" +
